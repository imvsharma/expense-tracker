                ...
                <FormField
                    ...
                    render={({field})=> (
                        <FormItem className="grid grid-cols-3 items-center gap-4">
                            ...
                            <FormControl>
                                <Input className="w-[270px]" type="text" placeholder="Enter transaction name" {...field} />
                            </FormControl>
                        </FormItem>
                    )}
                />
                ...
                <FormField
                    ...
                    render={({field})=> (
                        <FormItem className="grid grid-cols-3 items-center gap-4">
                            ...
                            <FormControl>
                                <Input className="w-[270px]" type="number" placeholder="Enter transaction amount" {...field} />
                            </FormControl>
                        </FormItem>
                    )}
                />
                                ...
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        <Button variant={"outline"} className={
                                            cn("w-[270px] pl-3 text-left font-normal",
